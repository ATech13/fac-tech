...
function formate(dateString: string): string {
...
const InvoicePDF: React.FC<FacturePDFProps> = ({ invoice, totals }) => {
    ...
    return (
        <div className='mt-4 hidden md:block'>
            <div className='imp border-base-300 border-2 border-dashed rounded-xl p-5'>
                ...
                <div className='p-8' ref={factureRef}>
                    <div className='flex justify-between items-center text-sm'>
                            ...
                            <div >
                                <div className='flex items-center'>
                                    ...
                                    <span className='ml-3 font-bold text-2xl italic'>
                                        Fac<span className='text-accent'>Tech</span>
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className='text-right uppercase'>
                            ...
                            <p className='my-2'>
                                <strong>Date : </strong>
                                {formate(invoice.invoiceDate)}
                            </p>

                            <p>
                                <strong>Date d&apos;échéance : </strong>
                                {formate(invoice.dueDate)}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className='my-6 flex justify-between'>
                        <div>
                            <p className='badge badge-ghost'>Emetteur</p>
                        ...
                        <div className='text-right'>
                            <p className='badge badge-ghost'>Client</p>
